...
result.frame.sorted <- result.frame[order(-auc.pred,-auc.p,-num.of.vars), ]

  head(result.frame.sorted[result.frame.sorted$auc.test>0.75 & result.frame.sorted$auc.p>0.75 & result.frame.sorted$num_of_vars==6,], n=100) # the 10 "best" combinations
```

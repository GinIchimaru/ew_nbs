...
model.large.final <-
  glm(
  formula = default.y~Racio_novcane_likvidnosti+Stepen_zaduzenosti+Vreme_naplate_potrazivanja+Stopa_prinosa_na_ukupna_sredstva_pre_oporezivanja+T14+Asset_turnover,  family = binomial(link = "logit"),
  data =my.vars
  )
...
final.roc.plot(model.large.final,my.vars,my.vars.test)
